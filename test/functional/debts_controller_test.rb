...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { Betrag: @debt.Betrag, Nachname: @debt.Nachname, Vorname: @debt.Vorname, info: @debt.info }
    end
  ...
  test "should update debt" do
    put :update, id: @debt, debt: { Betrag: @debt.Betrag, Nachname: @debt.Nachname, Vorname: @debt.Vorname, info: @debt.info }
    assert_redirected_to debt_path(assigns(:debt))
  end

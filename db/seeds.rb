...
#   Mayor.create(name: 'Emanuel', city: cities.first
	...
	flo = User.create email:'flo@paymeback.de', firstname:'Flo', lastname:'Kopp', password:'Test1234', password_confirmation: 'Test1234', adress: 'Hellmannsweg 19', :zip  => 46499, :city  => 'Hamminkeln', :dateofbirth => '1988-07-20'
	bjoern = User.create email:'bjoern@paymeback.de', firstname:'Bjoern', lastname:'Simon', password:'Test1234', password_confirmation: 'Test1234', adress: 'Steinfurterstrasse 80', :zip => 48153, :city => 'Muenster', :dateofbirth => '1987-01-05'
	lukas = User.create email:'lukas@paymeback.de', firstname:'Lukas', lastname:'Koopmann', password:'Test1234', password_confirmation: 'Test1234', adress: 'Warendorferstrasse 56', :zip => 48151, :city => 'Muenster', :dateofbirth => '1990-09-05'
	sabri = User.create email:'sabri@paymeback.de', firstname:'Sabri', lastname:'Koch', password:'Test1234', password_confirmation: 'Test1234', adress: 'Hauptstrasse 5', :zip => 48143, :city => 'Muenster-Albachten', :dateofbirth => '1988-01-02'
	lennard = User.create email:'lennard@paymeback.de', firstname:'Lennard', lastname:'Gudd', password:'Test1234', password_confirmation: 'Test1234', adress: 'Verbindungsstrasse 7', :zip => 48146, :city => 'Muenster', :dateofbirth => '1989-03-20'
	andre = User.create email:'andre@paymeback.de', firstname:'Andre', lastname:'Konetzka', password:'Test1234', password_confirmation: 'Test1234', adress: 'Sassendorferstrasse 12', :zip => 47123, :city => 'Bad Sassendorf', :dateofbirth => '1990-10-15'
